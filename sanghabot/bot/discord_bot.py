...
RAG_DISCLAIMER = "⚠️ This response was generated by AI from the excerpts below and may contain mistakes. Please verify against the source excerpts."
    ...
    async def perform_search(self, query: str, message: discord.Message, is_dm_private=False, is_dm_proxy=False):
        try:
            ...
            if answer_text:
                ...
                await post_target.send("_AI-generated response is temporarily unavailable right now — showing sources below._")
